<template>
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="设备Id">
          <el-input placeholder="搜索条件" v-model="searchInfo.machineId"></el-input>
        </el-form-item>    
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增设备</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="设备Id" prop="machineId" width="120"></el-table-column> 
    
    <el-table-column label="设备名称" prop="machineName" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateMachine(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
