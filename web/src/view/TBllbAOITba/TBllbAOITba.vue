  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">                                        
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增TBllbAOITba表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="LineID字段" prop="LineID" width="120"></el-table-column> 
    
    <el-table-column label="MachineType字段" prop="MachineType" width="120"></el-table-column> 
    
    <el-table-column label="OrderNo字段" prop="OrderNo" width="120"></el-table-column> 
    
    <el-table-column label="Program字段" prop="Program" width="120"></el-table-column> 
    
    <el-table-column label="PCBCode字段" prop="PCBCode" width="120"></el-table-column> 
    
    <el-table-column label="Result字段" prop="Result" width="120"></el-table-column> 
    
    <el-table-column label="CreateTime字段" prop="CreateTime" width="120"></el-table-column> 
    
    <el-table-column label="SysOwner字段" prop="SysOwner" width="120"></el-table-column> 
    ...
    <el-table-column label="InsType字段" prop="InsType" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateTBllbAOITba(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
...
export default {
  ...
  methods: {
      ...
      async onDelete() {
        ...
        const res = await deleteTBllbAOITbaByIds({ ids })
        if (res.code == 0) {
          this.$message({
            type: 'success',
            message: '删除成功'
    ...
    async updateTBllbAOITba(row) {
      const res = await findTBllbAOITba({ ID: row.ID });
      this.type = "update";
      if (res.code == 0) {
    ...
    async deleteTBllbAOITba(row) {
      const res = await deleteTBllbAOITba({ ID: row.ID });
      if (res.code == 0) {
        this.$message({
          type: "success",
          message: "删除成功"
