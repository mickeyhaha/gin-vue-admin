  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="SPIID">
          <el-input placeholder="搜索条件" v-model="searchInfo.sPIID"></el-input>
        </el-form-item>    
        <el-form-item>
          <el-button @click="onSubmit" type="primary">查询</el-button>
        </el-form-item>
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增SPI不良信息</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="SPIID" prop="sPIID" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateTS_SPI_CNT(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
...
export default {
  ...
  methods: {
      ...
      async onDelete() {
        ...
        const res = await deleteTS_SPI_CNTByIds({ ids })
        if (res.code == 0) {
          this.$message({
            type: 'success',
            message: '删除成功'
    ...
    async updateTS_SPI_CNT(row) {
      const res = await findTS_SPI_CNT({ ID: row.ID });
      this.type = "update";
      if (res.code == 0) {
    ...
    async deleteTS_SPI_CNT(row) {
      const res = await deleteTS_SPI_CNT({ ID: row.ID });
      if (res.code == 0) {
        this.$message({
          type: "success",
          message: "删除成功"
